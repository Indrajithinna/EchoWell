-- Minimal MindfulAI Database Schema
...
-- Create music_sessions table (if not exists)
...
-- Create therapy_goals table (if not exists)
...
DROP POLICY IF EXISTS "Users can view own music sessions" ON public.music_sessions;
DROP POLICY IF EXISTS "Users can create own music sessions" ON public.music_sessions;
DROP POLICY IF EXISTS "Users can update own music sessions" ON public.music_sessions;
DROP POLICY IF EXISTS "Users can delete own music sessions" ON public.music_sessions;
...
DROP POLICY IF EXISTS "Users can view own therapy goals" ON public.therapy_goals;
DROP POLICY IF EXISTS "Users can create own therapy goals" ON public.therapy_goals;
DROP POLICY IF EXISTS "Users can update own therapy goals" ON public.therapy_goals;
DROP POLICY IF EXISTS "Users can delete own therapy goals" ON public.therapy_goals;
